...
describe('BulkTextFixesService', () => {
  ...
  // Helper function to create mock paragraph data with required fields
  const createMockParagraph = (overrides: any = {}) => ({
    id: 'paragraph-1',
    bookId: mockBookId,
    pageId: 'page-1',
    orderIndex: 1,
    content: 'Default content',
    originalParagraphId: 'orig-paragraph-1',
    completed: false,
    audioS3Key: null,
  ...
  const mockParagraphs = [
    // Case 1: Original word exists as a full word - should be matched
    {
      ...
      content: 'זוהי פסקה עם המילה וגם בתוכה.',
          originalParagraphId: "orig-" + Math.random().toString(36).substring(7),
          completed: false,
      audioS3Key: null,
      audioStatus: AudioStatus.PENDING,
      audioDuration: null,
      ...
      const paragraphs = [
        {
          ...
          originalParagraphId: 'orig-p-contains-substring',
          completed: false,
          audioS3Key: null,
          audioStatus: AudioStatus.PENDING,
          audioDuration: null,
      ...
      const paragraphs = [
        {
          ...
          originalParagraphId: 'orig-p-numbers',
          completed: false,
          audioS3Key: null,
          audioStatus: AudioStatus.PENDING,
          audioDuration: null,
      ...
      const paragraphs = [
        {
          ...
          originalParagraphId: 'orig-p-hyphen',
          completed: false,
          audioS3Key: null,
          audioStatus: AudioStatus.PENDING,
          audioDuration: null,
